...
func TestNewContractAddress(t *testing.T) {
	...
	checkAddr(t, types.HexToAddress("a34361c80afebe5e9a116c49920c310f541a4be2"), caddr0)
	checkAddr(t, types.HexToAddress("06464b54c083aa40cb3d4e124df65df7d374ceac"), caddr1)
	checkAddr(t, types.HexToAddress("d95730a1ef0bb813e140a9da69b78230fe9d85dc"), caddr2)
}
