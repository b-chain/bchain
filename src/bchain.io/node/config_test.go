...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "bchaind.ipc", false, filepath.Join(os.TempDir(), "bchaind.ipc")},
		{"data", "bchaind.ipc", false, "data/bchaind.ipc"},
		{"data", "./bchaind.ipc", false, "./bchaind.ipc"},
		{"data", "/bchaind.ipc", false, "/bchaind.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "bchaind.ipc", true, `\\.\pipe\bchaind.ipc`},
		{"data", "bchaind.ipc", true, `\\.\pipe\bchaind.ipc`},
		{"data", `\\.\pipe\bchaind.ipc`, true, `\\.\pipe\bchaind.ipc`},
	}
