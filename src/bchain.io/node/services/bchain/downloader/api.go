...
// Syncing provides information when this nodes starts synchronising with the Bchain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  common.SyncProgress `json:"status"`
