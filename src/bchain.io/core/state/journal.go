...
func (ch interpreterIdChange)revert(s *StateDB) {
	s.getStateObject(*ch.account).setInterpreterID(ch.prev)
}

func (ch interpreterIdChange)dirtied() *types.Address {
	return ch.account
}

func (ch creatorChange)revert(s *StateDB) {
	s.getStateObject(*ch.account).setCreator(ch.prev)
}

func (ch creatorChange)dirtied() *types.Address {
	return ch.account
}
