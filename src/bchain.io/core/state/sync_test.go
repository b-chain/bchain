...
func makeTestState() (Database, *database.MemDatabase, types.Hash, []*testAccount) {
	...
	root, _, _ := state.CommitTo(mem, false)
...
// account array.
func checkStateAccounts(t *testing.T, db database.IDatabase, root types.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db database.IDatabase, root types.Hash) error {
...
func checkStateConsistency(db database.IDatabase, root types.Hash) error {
