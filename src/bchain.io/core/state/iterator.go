...
type NodeIterator struct {
	...
	accountHash types.Hash // Hash of the node containing the account
	codeHash    types.Hash // Hash of the contract source code
...
func (it *NodeIterator) step() error {
	...
	var account Account
	byteBuf := bytes.NewBuffer(it.stateIt.LeafBlob())
	if err := msgp.Decode(byteBuf, &account); err != nil {
		return err
	}
