...
func (s *StateSuite) TestDump(c *checker.C) {
	...
	obj3.SetCode(crypto.Keccak256Hash([]byte{3, 5, 3, 3, 5, 3, 5}), []byte{3, 5, 3, 3, 5, 3, 5})
	...
	want := `{
    "root": "0x5cbdb2f27608c5d631dd8caadc9fdf1ce8aa83bd52bbb7b8096fbd37641936ce",
    "accounts": {
        ...
        "0000000000000000000000000000000000000002": {
            "nonce": 0,
            "root": "56e81f171bcc55a6ff8345e692c0f86e5b48e01b996cadc001622fb5e363b421",
            "codeHash": "89e0e0af05a51f58639bd640d9e401d4f02e92da24b1340bd927d65860cec862",
            "code": "03050303050305",
            "storage": {}
        },
...
func (s *StateSuite) SetUpTest(c *checker.C) {
	s.db, _ = database.OpenMemDB()
	s.state, _ = New(types.Hash{}, NewDatabase(s.db))
}
...
func (s *StateSuite) TestNull(c *checker.C) {
	...
	s.state.CommitTo(s.db, false)
	value = s.state.GetState(address, types.Hash{})
	if !EmptyHash(value) {
...
func TestSnapshot2(t *testing.T) {
	...
	root, _, _ := state.CommitTo(db, false)
	state.Reset(root)
