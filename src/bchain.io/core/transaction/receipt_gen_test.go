...
func TestMarshalUnmarshalReceipts_s(t *testing.T) {
	v := Receipts_s{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgReceipts_s(b *testing.B) {
	v := Receipts_s{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgReceipts_s(b *testing.B) {
	v := Receipts_s{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalReceipts_s(b *testing.B) {
	v := Receipts_s{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodeReceipts_s(t *testing.T) {
	v := Receipts_s{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
...
func BenchmarkEncodeReceipts_s(b *testing.B) {
	v := Receipts_s{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeReceipts_s(b *testing.B) {
	v := Receipts_s{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
