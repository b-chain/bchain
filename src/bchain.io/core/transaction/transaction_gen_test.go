...
func BenchmarkMarshalMsgActions(b *testing.B) {
	v := Actions{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgActions(b *testing.B) {
	v := Actions{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalActions(b *testing.B) {
	v := Actions{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func BenchmarkEncodeActions(b *testing.B) {
	v := Actions{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeActions(b *testing.B) {
	v := Actions{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func TestMarshalUnmarshalTxByPriority(t *testing.T) {
	v := TxByPriority{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgTxByPriority(b *testing.B) {
	v := TxByPriority{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgTxByPriority(b *testing.B) {
	v := TxByPriority{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalTxByPriority(b *testing.B) {
	v := TxByPriority{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodeTxByPriority(t *testing.T) {
	v := TxByPriority{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
...
func BenchmarkEncodeTxByPriority(b *testing.B) {
	v := TxByPriority{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeTxByPriority(b *testing.B) {
	v := TxByPriority{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func TestMarshalUnmarshalTxHeader(t *testing.T) {
	v := TxHeader{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgTxHeader(b *testing.B) {
	v := TxHeader{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgTxHeader(b *testing.B) {
	v := TxHeader{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalTxHeader(b *testing.B) {
	v := TxHeader{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodeTxHeader(t *testing.T) {
	v := TxHeader{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
...
func BenchmarkEncodeTxHeader(b *testing.B) {
	v := TxHeader{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeTxHeader(b *testing.B) {
	v := TxHeader{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
