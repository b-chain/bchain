...
;(function () {
   ...
   basicBalanceTransfer = function(from1,to1, amount){
       ctxapi.console.print("======================== B basicBalanceTransfer================================\n")
       if (amount <= 0){
           ctxapi.assert.assert(false , "B basicBalanceTransfer Amount <= 0")
       }
    ...
    redeem = function(Amount){
        ctxapi.console.print("========================= B Redeem ================================\n")
        if (Amount <= 0){
            ctxapi.assert.assert(false , "B redeem Amount <= 0")
        }
