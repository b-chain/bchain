...
func TestDialStateNetRestrict(t *testing.T) {
	...
	// in the order given below.
	table := fakeTable{
		{ID: uintID(1), IP: *types.NewIP(net.ParseIP("127.0.0.1"))},
		{ID: uintID(2), IP: *types.NewIP(net.ParseIP("127.0.0.2"))},
		{ID: uintID(3), IP: *types.NewIP(net.ParseIP("127.0.0.3"))},
		{ID: uintID(4), IP: *types.NewIP(net.ParseIP("127.0.0.4"))},
		{ID: uintID(5), IP: *types.NewIP(net.ParseIP("127.0.2.5"))},
		{ID: uintID(6), IP: *types.NewIP(net.ParseIP("127.0.2.6"))},
		{ID: uintID(7), IP: *types.NewIP(net.ParseIP("127.0.2.7"))},
		{ID: uintID(8), IP: *types.NewIP(net.ParseIP("127.0.2.8"))},
	}
