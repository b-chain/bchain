...
// Account represents an bchain account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address types.Address `json:"address"` // bchain account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain common.ChainStateReader)
