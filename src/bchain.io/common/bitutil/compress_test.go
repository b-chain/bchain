...
import (
	...
	hexutil "bchain.io/common/types"
)
...
func TestDecodingCycle(t *testing.T) {
	...
	for i, tt := range tests {
		data := hexutil.MustDecodeHex(tt.input)
...
func TestCompression(t *testing.T) {
	...
	in := hexutil.MustDecodeHex("0x4912385c0e7b64000000")
	out := hexutil.MustDecodeHex("0x80fe4912385c0e7b64")
	...
	in = hexutil.MustDecodeHex("0xdf7070533534333636313639343638373532313536346c1bc33339343837313070706336343035336336346c65fefb3930393233383838ac2f65fefb")
	out = hexutil.MustDecodeHex("0xdf7070533534333636313639343638373532313536346c1bc33339343837313070706336343035336336346c65fefb3930393233383838ac2f65fefb")
